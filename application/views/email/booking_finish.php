										...
										<tr>
											<td height="25" valign="middle" align="left">
												...
												<table width="160" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															<td height="34" valign="middle" align="center" class="center-stack" ><a href="#"><img src="<?php echo base_url('/assets/img/logo.png'); ?>" width="160" height="34" alt="BB 45Trans" /></a></td>
														</tr>
													</tbody>
												</table>
												<!-- End Logo -->
													...
													<tbody>
														<tr>
															<td height="34" valign="bottom" align="right" class="center">
                                                            	<?php foreach($config['get_social_media_footer'] as $row) { ?>
                                                                <?php if($row->config == 'icon-facebook'){ ?>
																<a style="text-decoration: none; border:0;" href="<?php echo $row->value; ?>"><img src="<?php echo base_url('/assets/img/fb_bt.jpg'); ?>" width="27" height="27" alt="Our Facebook" /></a>
															&nbsp;
                                                            	<?php }else if($row->config == 'icon-google'){ ?>
																<a style="text-decoration: none; border:0" href="<?php echo $row->value; ?>"><img src="<?php echo base_url('/assets/img/google_pl_bt.jpg'); ?>" width="27" height="27" alt="Our Google plus" /></a>
															&nbsp;
                                                            <?php }else if($row->config == 'icon-twitter'){ ?>
																<a style="text-decoration: none; border:0" href="<?php echo $row->value; ?>"><img src="<?php echo base_url('/assets/img/twitter_bt.jpg'); ?>" width="27" height="27" alt="Our Twitter" /></a>
                                                                <?php }} ?>												
															</td>
														</tr>
													</tbody>
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
																					...
																					<tr>
																						...
																						BB 45Trans Transport & Tour Organizer</td>
																					</tr>
																					<tr>
																						<td height="20" style="line-height:20px; " ><hr /></td>
																					</tr>
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left"><p><strong>Booking completed</strong>, Thank you for choosing us as your travel and tourism services. below is your invoice</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																						...
																						<table width="100%">
																							...
																							<tr>
																								<td><?=$dataInvoice['id_invoice'];?></td>
																								<td><?=$dataInvoice['user_email'];?></td>
																								<td><?php echo date('d-M-Y', $dataInvoice['order_date']); ?></td>
																								<td><?=$dataInvoice['bank_name'];?></td>
																								<td><?php echo date('d-M-Y', $dataInvoice['date_tour']); ?></td>
																							</tr>
																						</table>
																						<br>
																						<hr>
																						<table cellspacing="0" cellpadding="0" border="0" align="center">
																								<tbody>
																									<tr>
																										<td align="center" style="border-radius:3px; color:#ffffff; display:block; font-family: Arial, Helvetica, sans-serif; font-size:12px; line-height:12px; text-align:center; text-decoration:none; padding-top: 10px; padding-bottom: 10px; width:130px; -webkit-text-size-adjust:none; background-color:#51bce6"><a style="color:#ffffff;font-family: Arial, Helvetica, sans-serif; font-size:12px; text-decoration:none !important" href="<?php echo base_url('invoice/'.$dataInvoice['id_invoice']);?>?v=<?=MD5($dataInvoice['id_invoice']); ?>">View Your Invoice</a></td>
																									</tr>
																								</tbody>
																							</table>												
																						</td>
													...
													<tr>	
														<td align="center">														
															...
															<table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">Contact Us : <?php echo $config['get_number']['value']; ?> Email : <?php echo $config['get_email']['value']; ?><br /><strong><?php echo $config['get_footer_copyright']['value']; ?></strong></td>
																	</tr>
																</tbody>
															</table>
															<!-- End Space -->
